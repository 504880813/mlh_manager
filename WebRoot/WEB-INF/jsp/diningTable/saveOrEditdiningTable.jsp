...
<div class="right_cont">
 ...
 <form id="diningTabledataForm" action="${pageContext.request.contextPath}/diningTable/${diningTable.id ==null ? 'addDiningTableSubmit' : 'editDiningTableSubmit'}.action" method="post" enctype="multipart/form-data">
   ...
   <table  class="table table-bordered">
     ...
     <tr>
       ...
       <td>
	       <input type="text" id="seatnumber" name="seatnumber" value="${diningTable.seatnumber}" >
	   </td>
     </tr>
     <c:if test="${customdiningTableImage==null}">
		<tr>
       ...
       <td>
	       <input type="file" id="freeimageFile" name="freeimageFile" />
	   	</td>
     	</tr>
     	<tr>
       <td align="right" bgcolor="#f1f1f1" >餐桌繁忙时图片:</td>
       <td>
	      <input type="file" id="busyimageFile" name="busyimageFile" />
	   	</td>
     	</tr>
	</c:if>
   	</tbody>
